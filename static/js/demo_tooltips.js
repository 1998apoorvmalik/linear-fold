...
$(document).on("mousemove", function (e) {
  $tooltipbox.css({
    left: e.pageX + TOOLTIP_OFFSET_X,
    top: e.pageY + TOOLTIP_OFFSET_Y,
  });
});
...
//   tooltip_on(e, "tooltipbox tooltipbox-lg tooltipbox-blue", (h2 = h2_height), (h1 = h1_height));
// });
// $("svg").on("mouseleave", ".tooltips-arcs", function (e) {
//   tooltip_off(e);
// });

// $("svg").on("mouseover", ".kBestNtArc", function (e) {
//   tooltip_on(e, "tooltipbox tooltipbox-sm tooltipbox-red");
// });
// $("svg").on("mouseleave", ".kBestNtArc", function (e) {
//   tooltip_off(e);
// });

// $("span").on("mouseover", ".alignedNtChangOn", function (e) {
//   tooltip_on(e, "tooltipbox tooltipbox-sm tooltipbox-red");
// });
// $("span").on("mouseleave", ".alignedNtChangOn", function (e) {
//   tooltip_off(e);
// });

// $("span").on("mouseover", ".alignedNtChangOff", function (e) {
//   tooltip_on(e, "tooltipbox tooltipbox-sm tooltipbox-grey");
// });
// $("span").on("mouseleave", ".alignedNtChangOff", function (e) {
//   tooltip_off(e);
// });

// $("span").on("mouseover", ".test", function (e) {
//   tooltip_on(e, "tooltipbox tooltipbox-sm tooltipbox-grey");
// });
// $("span").on("mouseleave", ".test", function (e) {
//   tooltip_off(e);
// });
...
$("span").on("mouseover", ".test", function (e) {
  highlightOn25(e, "tooltipbox tooltipbox-sm tooltipbox-red");
});
$("span").on("mouseleave", ".test", function (e) {
  highlightOff25(e);
});
